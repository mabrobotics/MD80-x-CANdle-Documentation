...
## Setting Up the Output Encoder

The configuration of the external (output) encoder must be performed **after** all motor parameters have been set and verified. The following registers define the encoder type, calibration behavior, and operational mode — see [**Object Dictionary**](/CANopen/object_dictionary.md) (0x2005 — Output Encoder) for the full sub-entry list:
