...
control algorithm (FOC_legacy), a high-resolution encoder, a high-speed FDCAN communication bus, and
a common communication interface. The controller feratures position PID, velocity PID, impedance,
...
[output encoders](output_encoder_legacy). The connector pinout is available below:
...
signals, while AUX2 is dedicated for the RS422 communication bus.
