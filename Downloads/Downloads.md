...
<table border="1" cellpadding="2" cellspacing="0"  class="gridlines sheet0" id="sheet0" style="float:center;text-align:center;font-size:11px ;width:100%">
	<tbody>
		...
		<tr>
			...
			<td><a href = https://github.com/mabrobotics/candle/releases/tag/v3.5.2>3.5.2</a></td>
			<td><a href = https://github.com/mabrobotics/mdtool/releases/tag/v1.5.2>1.5.2</a></td>
     		<td><a href = https://pypi.org/project/pyCandleMAB/1.6.0>1.6.0</a></td>
			<td><a>1.4.0</a></td>
			<td><a>1.4.0</a></td>
			<td><a href = ../candle-firmware/MAB_USB_Flasher_2.2.1.zip>2.2.1</a></td>
