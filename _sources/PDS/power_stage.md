...
Over current level and over current delay can be set in PDS configuration file and manually using candletool, see [PDS configuration file](config-pds) and [candletool for PDS](candletool-pds)
