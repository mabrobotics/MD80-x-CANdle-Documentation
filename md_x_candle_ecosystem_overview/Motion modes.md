...
1. Increase kp to the point you're satisfied with the stiffness of the output shaft (the spring coefficient)
2. Increase kd to the point you're satisfied with the damping of the output shaft (the damping coefficient)
